...
internal class DepartmentRemovedEventConsumer : IConsumer<DepartmentRemovedEvent>
{
  private readonly IDepartmentEventHandler _handler;

  public DepartmentRemovedEventConsumer(IDepartmentEventHandler handler)
  {
    _handler = handler;
  }

  public async Task Consume(ConsumeContext<DepartmentRemovedEvent> context)
  {
